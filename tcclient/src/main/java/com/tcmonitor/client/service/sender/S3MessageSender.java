...
public class S3MessageSender implements MessageSender {
    ...
    public void send(String message, String fileName) {
        try {
            saveMapper(logsPopulation.populate(message, fileName), bucket, FILE_NAME + System.currentTimeMillis());
        } catch (IOException e) {
            throw new RuntimeException(e.getMessage());
        }
    }

    private void saveMapper(Object object, String bucket, String fileName) throws IOException {
